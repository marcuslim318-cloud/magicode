...
| 第 12 关（护城星河·第三章收官） | level11Done = true | +480 | 把除咒/回溯/分身三招合成完整防御心法并归档 + 晋升「除咒师」 |
| 第 4–12 关 | 前一关完成 | 见上 | 见上 |

- 称号按**章**晋升，不是按关：第 0 关起称「收信人」；第一章（关卡 1–3）全通后晋升「施咒学徒」；第三章黑魔法防御课（关卡 9–12）全通后晋升更高一级的「除咒师」。「卷轴管理员」「工程巫师」「大魔导师」分属更后面的章节结业称号，不应提前占用。
